...
//             {/* Category Buttons - Mobile Two Rows */}
//             <div className="flex flex-col gap-2 lg:flex-row lg:overflow-visible lg:gap-3">
//               {/* Row 1: All, Veg, Non-Veg */}
...
//                       className={`flex-shrink-0 flex items-center gap-1 px-3 py-2 rounded-full text-sm font-medium whitespace-nowrap transition-all duration-200 ${
//                         selectedCategory === btn.key
//                           ? `bg-gradient-to-r from-${btn.color}-500 to-${btn.color}-600 text-black shadow-md`
...
//               {/* Row 2: Bestseller, Chef's Special */}
//               <div className="flex gap-2 overflow-x-auto scrollbar-hide">
//                 {categoryButtons
//                   .slice(3) // last 2 buttons
//                   .map((btn) => (
//                     <button
//                       key={btn.key}
//                       onClick={() => setSelectedCategory(btn.key)}
...
//               className="w-full lg:w-64 px-3 py-2 text-sm rounded-lg border border-gray-300 focus:ring-2 focus:ring-orange-400 focus:border-transparent outline-none transition-all duration-200 bg-gray-50 hover:bg-white"
//             />
//           </div>
//         </div>
