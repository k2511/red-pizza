...
// export default function GarlicSection({filter}) {
...
const comboData = [
  ...
  { id: 4, title: 'Italian Stuffed Garlic Bread + Cheesy Dip [FREE]', desc: "Garlic breadsticks stuffed with mushroom, olives & melting cheese. Served with Cheesy Dip. There ain't mush-room for anything else here. ;)", price: 179, img: imgi83, type: "veg" },
  { id: 5, title: 'Paneer Tikka Stuffed Garlic Bread + Cheesy Dip [FREE]', desc: "A lip-smacking fusion of paneer tikka, onions & melting cheese stuffed in freshly baked garlic breadsticks. Served with Cheesy Dip. Don't resist, tikka-it-away!", price: 179, img: imgi84, type: "veg", bestseller: true },
  { id: 6, title: 'Paneer Peri Peri Stuffed Garlic Bread + Cheesy Dip [FREE]', desc: "Garlic breadsticks stuffed with flavoursome peri-peri paneer, creamy peri-peri sauce & capsicum. Served with Cheesy Dip. A spicy side for your pizza party!", price: 179, img: imgi85, type: "veg" },
  { id: 7, title: "Mexican Chicken Stuffed Garlic Bread + Cheesy Dip [FREE]", desc: "Garlic breadsticks stuffed with herbed chicken, jalapenos & gooey cheese. Served with Cheesy Dip. Who can say no to this tempting combo?", price: 199, img: imgi86, type: "NonVeg" },
  { id: 8, title: 'Chicken Tikka Stuffed Garlic Bread + Cheesy Dip [FREE]', desc: "Chicken tikka, molten cheese & onions stuffed in freshly baked garlic breadsticks. Served with Cheesy Dip. You'll love this 'stuff'!", price: 199, img: imgi87, type: "NonVeg", bestseller: true },
  { id: 9, title: "Chicken Peri Peri Stuffed Garlic Bread + Cheesy Dip [FREE]", desc: "Perfectly baked garlic breadsticks spiced up with peri-peri chicken, creamy peri-peri sauce & capsicum. Served with Cheesy Dip. It's gonna be love at first bite!", price: 199, img: imgi88, type: "NonVeg" },
];
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        {filteredItems.map((combo) => (
          ...
          >
            ...
            <div className="p-4 flex flex-col justify-between h-[180px]">
              <h3 className="text-gray-800 font-semibold text-base mb-1 flex items-center gap-2">
                <img src={combo.type.toLowerCase() === "veg" ? vegIcon : nonVegIcon} alt={combo.type} className="w-4 h-4 object-contain" />
                {combo.title}
              </h3>
          ...
          <div className="bg-white rounded-lg p-6 w-11/12 sm:w-3/4 md:w-1/2 max-h-[90vh] overflow-y-auto relative">
            ...
            <div className="space-y-2 mb-6">
              {[
                ...
                <label key={i} className="flex justify-between items-center border-b py-2 cursor-pointer hover:bg-gray-50 rounded">
                  <div>
                    <input type="radio" name="crust" className="mr-2" />
                    {crust.name}
                  </div>
