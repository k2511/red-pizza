...
export default function BigNonSection() {
    ...
    <div className="max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="mb-6 text-center sm:text-left">
        <h2 className="text-lg sm:text-xl font-bold text-gray-800">
          BIG 10" Pizzas | nonVeg
        </h2>
        <p className="text-gray-600 text-sm sm:text-base mt-1">
          Go BIG with 10-inch Pizzas! 2X nonVeg toppings & overflowing cheese; hand
          ...
          >
            ...
            <div className="p-4 flex flex-col justify-between h-[180px]">
              <h3 className="text-gray-800 font-semibold text-base mb-1 flex items-center gap-2">
                <img
                  src={combo.type === "nonVeg" ? nonVegIcon : nonnonVegIcon}
                  alt={combo.type}
