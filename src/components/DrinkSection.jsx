...
export default function DrinkSection({ filter = "all", searchTerm = "" }) {
  const filteredItems = comboData.filter((item) => {
...
    <div className="max-w-7xl mx-auto px-4 py-6">
      <div className="mb-6 text-center sm:text-left">
        <h2 className="text-lg sm:text-xl font-bold text-gray-800">Desserts & Drinks</h2>
        <p className="text-gray-600 text-sm sm:text-base mt-1">Sweet treats & refreshing drinks.</p>
      </div>
