...
//             <img src={logo} alt="Logo" className="w-full h-12 object-cover rounded-full" />
//           </div>
//         </div>
...
//           {/* ✅ Mobile Login */}
//           <button className="w-full bg-white-900 text-red px-6 py-2 rounded-full flex items-center space-x-2 transition-colors">
//             <User className="w-4 h-4" />
//             <span>Login</span> / Signup
//           </button>
//         </div>
      ...
      <nav className="bg-white px-4 py-3 ">
        ...
        {isOpen && (
          <div className="md:hidden mt-3 space-y-2 flex flex-col items-start">
            ...
            <button
              onClick={() => setShowAuth(true)}
              className="w-full text-red px-6 py-2 rounded-full flex items-center space-x-2 transition-colors"
            >
              <User className="w-4 h-4" />
              <span>Login</span> / Signup
            </button>
