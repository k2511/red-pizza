...
//         {/* With image */}
//         <DealCard image={food1} discount="-40%" title="Chef Burgers RedPizza" />
//         <DealCard image={food2} discount="-20%" title="Grand Ai Cafe RedPizza" />
//         <DealCard image={food1} discount="-17%" title="Butterbrot Cafe RedPizza" />
//       </div>
//     </div>
//   );
// };
